...
@click.option('--iters_to_accumulate', help='iters_to_accumulate', metavar='INT', type=click.IntRange(min=1), required=False, default=1)
...
def main(**kwargs):
    ...
    c.iters_to_accumulate = opts.iters_to_accumulate
